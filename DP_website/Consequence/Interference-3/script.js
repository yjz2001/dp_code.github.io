...
function successful_step(){
  ...
  function fail_step(){
    ...
    <div id="container_intro" class="container_inform">
      <div class="container_inform_content">
          <p>Unfortunately, you've fallen for the <strong style="color:red;">Interface Interference</strong> trap! As a result, you'll spend money wasted. Would you like to retry?</p>
