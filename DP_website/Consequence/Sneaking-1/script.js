...
checkoutBtn.addEventListener('click', function() {
    if(i === 0){
        alert('You successfully buy the backpack and protect plan.');
        updateBadge(3);
        showTooltip_card();
    }
    else{
        alert('You successfully buy the backpack.');
        alert(' Congratulations! You successfully avoid trap.');
        window.location.href = '../Congrats/Sneaking-1.html';
