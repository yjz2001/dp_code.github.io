document.addEventListener("DOMContentLoaded", function () {
    ...
    // // 添加鼠标悬停事件监听器
    // acceptAllCookiesBtn.addEventListener('mouseover', function() {
    //     tooltipContainer.style.display = 'block'; // 显示提示框
    // });

    // // 添加鼠标离开事件监听器
    // acceptAllCookiesBtn.addEventListener('mouseout', function() {
    //     tooltipContainer.style.display = 'none'; // 隐藏提示框
    // });
});
